...
list_cloth = {
    ...
    {name = "Shirts", type = "Variation", item = 8, male_id = 15, female_id = 130},  
    {name = "Trunk", type = "Variation", item = 3, male_id = 15, female_id = 15},   
    {name = "Jackets", type = "Variation", item = 11, male_id = 91, female_id = 204},  
    {name = "Trunk", type = "Variation", item = 3, male_id = 15, female_id = 15},   
    {name = "Pants", type = "Variation", item = 4, male_id = 94, female_id = 15},   
    {name = "Shoes", type = "Variation", item = 6, male_id = 34, female_id = 46},   
