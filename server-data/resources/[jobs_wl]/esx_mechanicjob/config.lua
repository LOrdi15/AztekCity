...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = vector3(892.5494, -2102.506, 33.87402),
	...
	Craft = {
		Pos   = vector3( -323.140, -129.882, -137.999 ),
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = vector3(-366.354, -110.766, -137.696 ),
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = vector3(-386.899, -105.675, -137.683 ),
	...
	VehicleDelivery = {
		Pos   = vector3(-382.925, -133.748, -137.685 ),
...
Config.Clothes = {
    ...
    female = {
        ['tshirt_1'] = 200,  ['tshirt_2'] = 0,
        ['torso_1'] = 172,   ['torso_2'] = 0,
        ['arms'] = 23,
        ['pants_1'] = 83,   ['pants_2'] = 10,
