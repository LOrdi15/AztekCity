...
function UnJail()
	...
	TriggerServerEvent('InteractSound_SV:PlayOnSource', 'dooropen', 0.9)
	...
	Citizen.Wait(12000)
	DoScreenFadeIn(800)
	exports['okokNotify']:Alert("Prision", "Terminaste tu condena, por favor no vuelvas a la carcel", 3500, 'warning')
end
...
function InJail()
	...
	Citizen.CreateThread(function()
		...
		while jailTime > 0 do
			...
			exports['okokNotify']:Alert("Juez", "Fuiste mandado a prision por " .. jailTime .. " minutos", 3500, 'info')
...
function OpenJailMenu()
	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'jail_prison_menu',
		{
			...
			align    = 'center',
			elements = {
				{ label = "Mandar Persona A La Carcel", value = "jail_closest_player" },
				{ label = "Sacar Persona De La Carcel", value = "unjail_player" }
			}
		}, 
	function(data, menu)
			...
			ESX.UI.Menu.Open(
          	...
          	function(data2, menu2)
            	...
            	if jailTime == nil then
					exports['okokNotify']:Alert("Sistema", "Necesitas colocar los minutos en la carcel", 2500, 'error')
            	else
              		menu2.close()
              		...
              		if closestPlayer == -1 or closestDistance > 3.0 then
						exports['okokNotify']:Alert("Sistema", "No hay jugadores cerca", 2500, 'error')
					else
						ESX.UI.Menu.Open(
						...
						function(data3, menu3)
						  	...
						  	if reason == nil then
								exports['okokNotify']:Alert("Sistema", "Necesitas colocar la razon por la cual entra a la carcel", 2500, 'error')
						  	else
								menu3.close()
