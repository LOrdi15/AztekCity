...
AddEventHandler("esx-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	...
	GetRPName(targetSrc, function(Firstname, Lastname)
		TriggerClientEvent('chat:addMessage', -1, { args = { "JUEZ",  Firstname .. " " .. Lastname .. " fue sentenciado a prision. Razon: " .. jailReason }, color = { 249, 166, 0 } })
	end)

	exports['okokNotify']:Alert("Sistema", "Mandaste correctamente a la carcel al jugador!", 3500, 'success')
end)
