const sound_click_button = new Audio('https://cdn.discordapp.com/attachments/977024661567193098/1013383327199268924/click.ogg'); //Sound Button
const sound_click_advanced_button = new Audio("https://cdn.discordapp.com/attachments/977024661567193098/1013383237315338310/transition.ogg")
...
$(window).ready(function () {
  ...
  $(document).on(
    ...
    function (event) {
      ...
      $('li[data-page="garage"]').addClass('selected')
      $('li[data-page="impounded"]').removeClass('selected')
      sound_click_advanced_button.play()
    }
  )
