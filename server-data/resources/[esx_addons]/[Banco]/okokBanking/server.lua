...
AddEventHandler("okokBanking:DepositMoney", function(amount)
	...
	if amount <= playerMoney then
		...
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has depositado "..amount.."€", 5000, 'success')
	else
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "No tienes esa cantidad de dinero", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:WithdrawMoney", function(amount)
	...
	if amount <= playerMoney then
		...
		TriggerClientEvent('okokBanking:updateTransactions', source, xPlayer.getAccount('bank').money, xPlayer.getMoney())
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has extraido "..amount.."€", 5000, 'success')
	else
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "No tienes esa cantidad de dinero", 5000, 'error')
	end
end)
	...
	if xPlayer.identifier ~= targetIdentifier then
		if amount <= playerMoney then
			...
			if xTarget ~= nil then
				...
				for i=1, #xPlayers, 1 do
				    ...
				    if xForPlayer.identifier == targetIdentifier then
				    	...
				    	TriggerClientEvent('okokNotify:Alert', xPlayers[i], "Bankia", "Has recibido "..amount.."€ de "..xPlayer.getName(), 5000, 'success')
				    end
				end
				TriggerEvent('okokBanking:AddTransferTransaction', amount, xTarget, source)
				TriggerClientEvent('okokBanking:updateTransactions', source, xPlayer.getAccount('bank').money, xPlayer.getMoney())
				TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has transferido "..amount.."€ a "..xTarget.getName(), 5000, 'success')
			elseif xTarget == nil then
				...
				TriggerClientEvent('okokBanking:updateTransactions', source, xPlayer.getAccount('bank').money, xPlayer.getMoney())
				TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has transferido "..amount.."€ a "..targetName, 5000, 'success')
		...
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "No te puedes enviar dinero a tu mismo", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:DepositMoneyToSociety", function(amount, society, societyName)
	...
	if amount <= playerMoney then
		...
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has depositado "..amount.."€ to "..societyName, 5000, 'success')
	else
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "No tienes esa cantidad de dinero", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:WithdrawMoneyToSociety", function(amount, society, societyName, societyMoney)
	...
	if amount <= db.value then
		if db.is_withdrawing == 1 then
			...
			TriggerClientEvent('okokNotify:Alert', _source, "Bankia", "Has extraido"..amount.."€ de "..societyName, 5000, 'success')
		end
	else
		TriggerClientEvent('okokNotify:Alert', _source, "Bankia", "La sociedad no tienes esa cantidad de dinero", 5000, 'error')
	end
...
AddEventHandler("okokBanking:TransferMoneyToSociety", function(amount, ibanNumber, societyName, society)
	...
	local playerMoney = xPlayer.getAccount('bank').money
		...
		if amount <= playerMoney then
			...
			TriggerClientEvent('okokBanking:updateTransactionsSociety', source, xPlayer.getMoney())
			TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has transferido "..amount.."€ a "..societyName, 5000, 'success')
		else
			TriggerClientEvent('okokNotify:Alert', source, "Bankia", "No tienes esa cantidad de dinero", 5000, 'error')
		end
end)
...
AddEventHandler("okokBanking:TransferMoneyToSocietyFromSociety", function(amount, ibanNumber, societyNameTarget, societyTarget, society, societyName, societyMoney)
	...
	if amount <= societyMoney then
		...
		TriggerClientEvent('okokBanking:updateTransactionsSociety', source, xPlayer.getMoney())
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Has transferido "..amount.."€ a "..societyNameTarget, 5000, 'success')
	else
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Tu sociedad no tiene esa cantidad de dinero", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:UpdateIbanDB", function(iban, amount)
	...
	if Config.IBANChangeCost <= xPlayer.getAccount('bank').money then
		...
		TriggerEvent('okokBanking:AddTransferTransactionToSociety', amount, source, "bank", "Banco (IBAN)")
		TriggerClientEvent('okokBanking:updateIban', source, iban)
		TriggerClientEvent('okokBanking:updateIbanPinChange', source)
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "IBAN scambiado a "..iban, 5000, 'success')
	else
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "Necesitas tener"..Config.IBANChangeCost.."€ para cambiar el IBAN", 5000, 'error')
	end
end)
...
AddEventHandler("okokBanking:UpdatePINDB", function(pin, amount)
	...
	if Config.PINChangeCost <= xPlayer.getAccount('bank').money then
		...
		TriggerEvent('okokBanking:AddTransferTransactionToSociety', amount, source, "bank", "Banco (PIN)")
		TriggerClientEvent('okokBanking:updateIbanPinChange', source)
		TriggerClientEvent('okokNotify:Alert', source, "Bankia", "PIN cambiado a "..pin, 5000, 'success')
	else
		TriggerClientEvent('okokNotify:Alert', source, "BANK", "Necesitas "..Config.PINChangeCost.."€ para cambiar el pin", 5000, 'error')
	end
end)