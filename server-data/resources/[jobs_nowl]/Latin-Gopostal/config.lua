...
Config.Warehouse = {
	JobStart = {
		Pos   = {x = 94.64, y = -2676.28, z = 6.0},
		Size  = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 78, g = 2453, b = 175},
		Type  = 27,
        BlipLabel = '[GO POSTAL] Central',
        BlipColor = 24,
        BlipScale = 1.0,
	},
	Boss = {
		Pos   = {x = 99.24, y = -2675.28, z = 6.0},
		Size  = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 78, g = 2453, b = 175},
		Type  = 27,
        BlipLabel = '[GO POSTAL] Jefe',
        BlipColor = 24,
        BlipScale = 0.6,
	},
    Garage = {
