...
Config.seatbeltkey = "k"   --- set this if RegisterKeymmaping is true
Config.cruisekey = "b"  -- set this if RegisterKeymmaping is true
...
Config.Notify1 ={text = "You put on seat belt", type = 'info', time = 5000 }   -- 
Config.Notify2 ={text ="You took of seat belt", type = "info", time = 5000 }  -- 
Config.Notify3 = {text = "You turned on cruise control", type ="info" , time  = 5000}  -- 
Config.Notify4 = {text = "You turned off cruise control", type ="info" , time  = 5000}  ---
