...
setTimeout(() => {
  $.post("https://orquidea-principal-hud/Ready", JSON.stringify({}));
...
$(document).on("click", "#exit", function () {
  $.post("https://orquidea-principal-hud/close");
  $(".settings").hide(0);
...
$(document).on("click", "#showcompass", function () {
  $.post("https://orquidea-principal-hud/showcompass");

});

$(document).on("click", "#hidecompass", function () {
  $.post("https://orquidea-principal-hud/hidecompass");

});

$(document).on("click", ".options-mph", function () {
  $.post("https://orquidea-principal-hud/mph");

});


$(document).on("click", ".compass-onmap-img", function () {
  $.post("https://orquidea-principal-hud/conkmpass-onmap");

});

$(document).on("click", ".compass-bottom", function () {
  $.post("https://orquidea-principal-hud/compass-bottom");

});
$(document).on("click", ".compass-top-img", function () {
  $.post("https://orquidea-principal-hud/compass-top");
});



$(document).on("click", ".options-kmh", function () {
  $.post("https://orquidea-principal-hud/kmh");

});


$(document).on("click", "#hidehud", function () {
  $.post("https://orquidea-principal-hud/hidehud");
});

$(document).on("click", "#radialhud", function () {
  $.post("https://orquidea-principal-hud/radialhud");
});

$(document).on("click", "#venicehud", function () {
  $.post("https://orquidea-principal-hud/venicehud");
});

$(document).on("click", "#texthud", function () {
  $.post("https://orquidea-principal-hud/texthud");
});


$(document).on("click", "#showhud", function () {
  $.post("https://orquidea-principal-hud/showhud");
});

$(document).on("click", "#enable-cinematic", function () {
  $.post("https://orquidea-principal-hud/cinematicmode");
});

$(document).on("click", "#disable-cinematic", function () {
  $.post("https://orquidea-principal-hud/disablecinematicmode");
});
...
window.addEventListener("message", function (event) {
  ...
  if (typeof item.preferences !== "undefined") {
    ...
    } else if (item.preferences.hud == "venicehud") {
